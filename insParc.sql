...
-- Requêtes afin d'insérer les données du TP dans les tables Segment, Salle, Poste, Logiciel, Types.
-- Modèle : INSERT INTO <table> (column1, column2, ...) VALUES (value1.1, value1.2, ...), (value2,1, valuee 2.2, ...);
INSERT INTO Segment 
...
VALUES 
    ...
    ("log4", "Front Page", "1997-06-3", "5", "PCWS", "500"),
...
-- Requête pour gérer la séquence associée à al colonne numIns, afin de faire en sorte qu'elle s'auto incrémente sur tous les enregistrements suivants.
-- Pour cela : on moddifie la tabvle afin de metttre une auto incrémentation par défaut ssur ceette colonne. 
-- Modèle : ALTER TABLE <table> MODIFY COLUMN <column> <variable_type> AUTO_INCREMENT;
ALTER TABLE Installer MODIFY COLUMN numIns INTEGER(5) AUTO_INCREMENT;

-- Requêtes afin d'insérer la table Installer
-- Modèle : INSERT INTO <table> (column1, column2, ...) VALUES (value1.1, value1.2, ...), (value2,1, valuee 2.2, ...);
INSERT INTO Installer
    (nPoste, nLog, dateIns, delai)
VALUES
